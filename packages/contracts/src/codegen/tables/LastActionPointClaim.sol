...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("LastActionPointC")));
bytes32 constant LastActionPointClaimTableId = _tableId;

library LastActionPointClaim {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("LastActionPointClaim", _fieldNames);
  }
