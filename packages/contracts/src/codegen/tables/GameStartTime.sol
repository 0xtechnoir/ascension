...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("GameStartTime")));
bytes32 constant GameStartTimeTableId = _tableId;
...
library GameStartTime {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("GameStartTime", _fieldNames);
  }
