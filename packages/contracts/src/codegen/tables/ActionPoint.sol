...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("ActionPoint")));
bytes32 constant ActionPointTableId = _tableId;
...
library ActionPoint {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("ActionPoint", _fieldNames);
  }
