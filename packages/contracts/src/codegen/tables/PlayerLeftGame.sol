...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("PlayerLeftGame")));
bytes32 constant PlayerLeftGameTableId = _tableId;
...
library PlayerLeftGame {
  ...
  function emitEphemeral(uint256 id, PlayerLeftGameData memory _table) internal {
  ...
  function emitEphemeral(IStore _store, uint256 id, PlayerLeftGameData memory _table) internal {
