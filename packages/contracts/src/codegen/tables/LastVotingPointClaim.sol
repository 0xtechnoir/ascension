...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("LastVotingPointC")));
bytes32 constant LastVotingPointClaimTableId = _tableId;

library LastVotingPointClaim {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("LastVotingPointClaim", _fieldNames);
  }
