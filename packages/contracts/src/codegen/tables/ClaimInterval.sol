...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("ClaimInterval")));
bytes32 constant ClaimIntervalTableId = _tableId;

library ClaimInterval {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("ClaimInterval", _fieldNames);
  }
