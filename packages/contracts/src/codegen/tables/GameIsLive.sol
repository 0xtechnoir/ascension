...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("GameIsLive")));
bytes32 constant GameIsLiveTableId = _tableId;
...
library GameIsLive {
  ...
  function get(IStore _store) internal view returns (bool value) {
    bytes32[] memory _keyTuple = new bytes32[](0);
  ...
  function set(IStore _store, bool value) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
