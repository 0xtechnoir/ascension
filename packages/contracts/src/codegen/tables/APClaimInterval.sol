...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("APClaimInterval")));
bytes32 constant APClaimIntervalTableId = _tableId;

library APClaimInterval {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("APClaimInterval", _fieldNames);
  }
