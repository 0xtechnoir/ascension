...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("VotingPoint")));
bytes32 constant VotingPointTableId = _tableId;
...
library VotingPoint {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("VotingPoint", _fieldNames);
  }
